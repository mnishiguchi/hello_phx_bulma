defmodule HelloPhxBulmaWeb.Router do
  use HelloPhxBulmaWeb, :router

  import Surface.Catalogue.Router

  import HelloPhxBulmaWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {HelloPhxBulmaWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: HelloPhxBulmaWeb.Telemetry
    end
  end
