defmodule HelloPhxBulmaWeb.QuestionOptionLiveTest do
  ...
  defp create_question_option(_) do
    ...
    %{question: question, question_option: question_option}
  end

  describe "Index" do
    setup [:create_question_option]

    test "lists all question_options", %{
      conn: conn,
      question: question,
      ...
      {:ok, _index_live, html} =
        live(
          conn,
          Routes.question_option_index_path(conn, :index, question_id: question.id)
        )
    ...
    test "saves new question_option", %{
      conn: conn,
      question: question,
      question_option: question_option
    } do
      ...
      assert_patch(
        index_live,
        Routes.question_option_index_path(conn, :new, question_id: question.id)
      )
    ...
    test "updates question_option in listing", %{
      conn: conn,
      question: question,
      question_option: question_option
    } do
      ...
      assert index_live
             |> element("#question_option-#{question_option.id} a", "Edit")
             |> render_click() =~
               "Edit Question option"

      assert_patch(
        index_live,
        Routes.question_option_index_path(conn, :edit, question_option, question_id: question.id)
      )
    ...
    test "deletes question_option in listing", %{
      conn: conn,
      question: question,
      question_option: question_option
    } do
      ...
      assert index_live
             |> element("#question_option-#{question_option.id} a", "Delete")
             |> render_click()
  ...
  describe "Show" do
    ...
    test "displays question_option", %{
      ...
      {:ok, _show_live, html} =
        live(
          conn,
          Routes.question_option_show_path(conn, :show, question_option, question_id: question.id)
        )
    ...
    test "updates question_option within modal", %{
      conn: conn,
      question: question,
      question_option: question_option
    } do
      ...
      assert_patch(
        show_live,
        Routes.question_option_show_path(conn, :edit, question_option, question_id: question.id)
      )
